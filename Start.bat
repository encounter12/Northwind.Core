...
start "Northwind Rest API" cmd /c "dotnet Northwind.Api.dll --server.urls ""https://localhost:44377""
popd

pushd Northwind.WebApps\Northwind.Mvc\bin\Release\netcoreapp2.1\publish\
start "Northwind Web App (MVC)" cmd /c "dotnet Northwind.Mvc.dll --server.urls ""https://localhost:44364""
popd